                                ...
                                <div class="table-responsive">
                                    <table class="table align-items-center table-flush">
                                        ...
                                        <thead class="thead-light">
                                            <tr>
                                                <th scope="col" class="sort" data-sort="id_peminjaman_r">ID Peminjaman</th>
                                                <th scope="col" class="sort" data-sort="id_user">ID User</th>
                                                <th scope="col" class="sort" data-sort="id_ruangan">ID Ruangan</th>
                                                <th scope="col" class="sort" data-sort="cek_in">Check In</th>
                                                <th scope="col" class="sort" data-sort="cek_out">Check Out</th>
                                                <th scope="col" class="sort" data-sort="keperluan">Keperluan</th>
                                                <th scope="col"></th>
                                            </tr>
                                        </thead>
                                        ...
                                        <%
                                            for (int i = 0; i < daftarPinjamLab.length; i++) {
                                                pl = daftarPinjamLab[i];
                                        %>
                                        ...
                                        <tr>
                                            <td>
                                                <!--ID PINJAM LAB-->
                                                <jsp:getProperty name="PinjamLab" property="id_peminjaman_r" />
                                            </td>
                                            <td>
                                                <!--ID USER-->
                                                <jsp:getProperty name="PinjamLab" property="id_user" />
                                            </td>
                                            <td>
                                                <!--ID RUANGAN-->
                                                <jsp:getProperty name="PinjamLab" property="id_ruangan" />
                                            </td>
                                            <td>
                                                <!--CHECK IN-->
                                            ...
                                            <td>
                                                <!--KEPERLUAN-->
                                                <jsp:getProperty name="PinjamLab" property="keperluan" />
                                            </td>
                                            <td class="text-right">
                                                <div class="dropdown">
